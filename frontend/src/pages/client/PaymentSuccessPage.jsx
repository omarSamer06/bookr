    ...
    <div className="mx-auto max-w-lg space-y-6 px-4 py-16">
      <Card className="border-border/80">
        ...
        <CardContent className="space-y-4">
          ...
          <Link to="/dashboard/appointments" className={cn(buttonVariants({ variant: 'default' }), 'inline-flex')}>
            Go to my appointments
          </Link>
          <Link to="/businesses" className={cn(buttonVariants({ variant: 'outline' }), 'inline-flex')}>
